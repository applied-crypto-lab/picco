...
public:
    ...
    void convertFloat(float value, int K, int L, priv_int **elements);
    void convertDouble(double value, int K, int L, priv_int **elements);
    ...
    void smc_batch_free_operator(priv_int **op, int size);
    void smc_batch_free_operator(priv_int ***op, int size);
    ...
    void smc_process_operands(priv_int **a, priv_int **b, int alen_sig, int alen_exp, int blen_sig, int blen_exp, int *len_sig, int *len_exp, int size);
