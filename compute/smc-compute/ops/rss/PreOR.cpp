...
void Rss_PreOR(Lint **input, uint size, uint ring_size, NodeNetwork *nodeNet) {
            ...
            for (l = 0; l < size; ++l) {
                for (j = 0; j < op_r; ++j) {
                    ...
                    for (size_t s = 0; s < numShares; s++) {
                        ...
                        input[s][l] = SET_BIT(input[s][l], mask2, temp);
