 ...
 */
static aststmt statement_cases(aststmt st, int nsec) {
    aststmt cases = NULL;
 ...
 */
static aststmt sections_cases(aststmt body, int nsec, aststmt lasts) {
    aststmt st = NULL;
            ...
            Compound(
                BlockList(
                    verbit(
                        ...
                        "\n\t else { if ((++caseid_) >= %d) break;}",
                        nsec),
                    s)),
            hasred ? BlockList(reds,
