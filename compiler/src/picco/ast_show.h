...
void ast_decl_memory_assign_rss_var_int(astdecl);
void ast_decl_memory_free_rss_var_int(astdecl);
void ast_decl_memory_assign_rss_var_float(astdecl);
void ast_decl_memory_free_rss_var_float(astdecl);
...
void ast_batch_iter_tree(aststmt, int *, int *, int *, int *);
...
void ast_batch_compute_index(aststmt, int *, int *, int *, int *, int *, int *, branchnode);
void ast_batch_compute_stmt(aststmt, int *, int *, int *, int *, int *, branchnode);
void ast_batch_print_index(aststmt, int, int, int *, int *, int *, branchnode, int *, int);
void ast_batch_print_index_operator(str, astexpr, int, int *);
void ast_batch_print_cond(aststmt, str);
