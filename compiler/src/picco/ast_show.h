...
void ast_temporary_float_array_declaration(astexpr, int, int);
void ast_temporary_int_array_declaration(astexpr, int, int);
...
void ast_array_float_tmp_clear_show(astexpr, int, int);
void ast_array_tmp_clear_show(astexpr, int, int);
